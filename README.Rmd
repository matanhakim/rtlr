...
2.  The dot in the end of the sentance is placed wrongly on the right side, while it should be on the left.
...
Notice how the lines are split with now overflow, and how the final dot is placed on the left side, where it should be.
